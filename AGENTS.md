...
- For personal-first milestones, prefer one final Product Owner manual product/UX acceptance after required automated risk-tier evidence is green. Do not multiply broad automated or UI-smoke runs merely to replace owner acceptance. Manual acceptance never replaces mandatory Security/Data Critical proof.
